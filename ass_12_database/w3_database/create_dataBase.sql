...
ALTER TABLE orders
 ADD CONSTRAINT shipping_fk FOREIGN KEY (`shipping_id`) 
...
INSERT INTO `employees` (`employeeId`, `last_name`, `frist_name`, `birthday`, `photo`,  `notes`) 
VALUES
...
INSERT INTO `products` (`product_id`,`product_name`, `supplier_id`, `categoryId`,`unit`,`price`) 
VALUES
...
INSERT INTO `orders` (`order_id`,`customerId`, `employeeId`, `order_date`,`shipping_id`) 
VALUES
